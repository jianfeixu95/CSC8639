...
# RSNA Pneumonia
PNEUMONIA_DATA_DIR = Path("/Volumes/G-RAID/个人库/代码/jupyter-notebook/workspace/CSC8639/mimic-cxr-jpg-v2.1.0/Model/image-classification-model/datasets/rsna_pneumonia")  # aimi0/rsna_pneumonia')
PNEUMONIA_ORIGINAL_TRAIN_CSV = PNEUMONIA_DATA_DIR / "stage_2_train_labels.csv"
PNEUMONIA_TRAIN_CSV = PNEUMONIA_DATA_DIR / "train.csv"
PNEUMONIA_VALID_CSV = PNEUMONIA_DATA_DIR / "valid.csv"
