...
def get_val_losses_and_evaluate_obj_detector_and_binary_classifiers(
        model, val_dl, log_file, epoch,
        pretrain_without_lm_model,weight_object_detector_loss,
        weight_language_model_loss,weight_binary_classifier_region_selection_loss,
...
def evaluate_model(
        model, train_losses_dict, val_dl, lr_scheduler, optimizer,
        scaler, writer, tokenizer, run_params, generated_sentences_and_reports_folder_path,
        pretrain_without_lm_model,weight_object_detector_loss,
        weight_language_model_loss,weight_binary_classifier_region_selection_loss,
        weight_binary_classifier_region_abnormal_loss,
        batch_size,
    ...
    (
        ...
        region_selection_scores,
        region_abnormal_scores,
    ) = get_val_losses_and_evaluate_obj_detector_and_binary_classifiers(
        model, val_dl, log_file, epoch,
        pretrain_without_lm_model, weight_object_detector_loss,
        weight_language_model_loss, weight_binary_classifier_region_selection_loss,
        weight_binary_classifier_region_abnormal_loss)
    ...
    # 修改 100000 变成 1
    if not pretrain_without_lm_model and overall_steps_taken > 100000:
        language_model_scores = evaluate_language_model(
